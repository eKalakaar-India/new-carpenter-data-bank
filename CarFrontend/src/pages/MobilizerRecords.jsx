...
export default function MobilizerRecords() {
  const { 
    records, 
    recordsMobilizer,
    recordsLoading, 
  ...
  const handleSelectAll = (e) => {
    if (e.target.checked) {
      setSelectedIds(recordsMobilizer.map(r => r.id));
    } else {
      setSelectedIds([]);
    }
  };
            ...
            >
              ...
              <thead>
                <tr>
                  ...
                  <th className="w-4">Full Name</th>
                  <th className="w-4">Batch Data</th>
                  <th className="w-4">Certificate</th>
                  <th className="w-4">Insurance</th>
                  <th className="w-4 text-center">Credentials Vault</th>
                  <th className="w-4">State</th>
                  <th className="w-4">District</th>
                </tr>
              </thead>
              <tbody>
                {recordsMobilizer && recordsMobilizer.map((rec, index) => (
                  <tr 
                     key={rec.id} 
                ...
                {recordsMobilizer && recordsMobilizer.length === 0 && (
                  <tr>
